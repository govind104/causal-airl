...
j5=$(qsub -N cartpole_comparison        -hold_jid $j4 scripts/run_cartpole_comparison.sh      | awk '{print $3}')
j6=$(qsub -N generalisation_test        -hold_jid $j5 scripts/run_generalisation_test.sh      | awk '{print $3}')
